...
# 2 "<built-in>" 2
# 1 "lab_02_hls/find_core.c" 2
__attribute__((sdx_kernel("find", 0))) void find(char val, char in_vec[10], char out_vec[10]) {
#line 14 "C:/Users/pcost/Documents/github/Dissertation/training/leonardo_tutorials_hls/lab_02_hls/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=find
# 1 "lab_02_hls/find_core.c"
