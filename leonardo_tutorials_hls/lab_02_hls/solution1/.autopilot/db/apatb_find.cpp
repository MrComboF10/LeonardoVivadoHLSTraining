...
#define AUTOTB_TVOUT_val_r "../tv/cdatafile/c.find.autotvout_val_r.dat"
#define AUTOTB_TVIN_in_vec "../tv/cdatafile/c.find.autotvin_in_vec.dat"
#define AUTOTB_TVOUT_in_vec "../tv/cdatafile/c.find.autotvout_in_vec.dat"
...
extern "C"
void find_hw_stub_wrapper(hls::sim::Byte<1>, void*, void*);

extern "C"
void apatb_find_hw(hls::sim::Byte<1> __xlx_apatb_param_val_r, void* __xlx_apatb_param_in_vec, void* __xlx_apatb_param_out_vec)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_in_vec),
#endif
  };
  port1.param = __xlx_apatb_param_in_vec;
  port1.depth = 10;
  port1.hasWrite = false;

  static hls::sim::FIFO port2 {
    .width = 8,
    .asize = 1,
    .name = "out_vec",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_out_vec),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_out_vec),
    .iwriter = nullptr,
#endif
  };
  port2.param = __xlx_apatb_param_out_vec;
  port2.depth = 10;
  port2.hasWrite = true;
  ...
  try {
    ...
    find_hw_stub_wrapper(__xlx_apatb_param_val_r, __xlx_apatb_param_in_vec, __xlx_apatb_param_out_vec);
