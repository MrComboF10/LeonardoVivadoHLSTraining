...
#define AUTOTB_TVIN_d "../tv/cdatafile/c.gravity.autotvin_d.dat"
#define AUTOTB_TVOUT_d "../tv/cdatafile/c.gravity.autotvout_d.dat"
...
extern "C"
float gravity_hw_stub_wrapper(float, float, float);

extern "C"
float apatb_gravity_hw(float __xlx_apatb_param_m1, float __xlx_apatb_param_m2, float __xlx_apatb_param_d)
{
  float ap_return;
  ...
  try {
    ...
    ap_return = gravity_hw_stub_wrapper(__xlx_apatb_param_m1, __xlx_apatb_param_m2, __xlx_apatb_param_d);
