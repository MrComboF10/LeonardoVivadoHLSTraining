...
reg  signed [31:0] gain_read_reg_204;
reg  signed [31:0] tmp_data_V_reg_212;
reg    ap_block_state2_pp0_stage0_iter0;
wire    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_state4_pp0_stage0_iter2;
reg    ap_block_state5_pp0_stage0_iter3;
reg    ap_block_pp0_stage0_11001;
reg   [3:0] tmp_keep_V_reg_217;
reg   [3:0] tmp_keep_V_reg_217_pp0_iter1_reg;
reg   [3:0] tmp_strb_V_reg_222;
reg   [3:0] tmp_strb_V_reg_222_pp0_iter1_reg;
reg   [1:0] tmp_user_V_reg_227;
reg   [1:0] tmp_user_V_reg_227_pp0_iter1_reg;
reg   [0:0] tmp_last_V_reg_232;
reg   [0:0] tmp_last_V_reg_232_pp0_iter1_reg;
reg   [4:0] tmp_id_V_reg_237;
reg   [4:0] tmp_id_V_reg_237_pp0_iter1_reg;
reg   [5:0] tmp_dest_V_reg_242;
reg   [5:0] tmp_dest_V_reg_242_pp0_iter1_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_fu_86 <= 10'd0;
    end else if (((icmp_ln13_fu_147_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln13_fu_147_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln13_fu_147_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln13_fu_147_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln13_fu_147_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln13_fu_147_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter3 == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter3 == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((icmp_ln13_fu_147_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter3 == 1'b1) & (outStream_TREADY_int_regslice == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (outStream_TREADY_int_regslice == 1'b0)) | ((icmp_ln13_fu_147_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (inStream_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter3 == 1'b1) & (outStream_TREADY_int_regslice == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (outStream_TREADY_int_regslice == 1'b0)) | ((icmp_ln13_fu_147_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (inStream_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter3 == 1'b1) & (outStream_TREADY_int_regslice == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (outStream_TREADY_int_regslice == 1'b0)) | ((icmp_ln13_fu_147_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (inStream_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((icmp_ln13_fu_147_p2 == 1'd0) & (inStream_TVALID_int_regslice == 1'b0));
end
...
assign i_2_fu_153_p2 = (i_fu_86 + 10'd1);

assign icmp_ln13_fu_147_p2 = ((i_fu_86 == 10'd1000) ? 1'b1 : 1'b0);
