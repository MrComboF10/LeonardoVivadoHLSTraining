...
$(ObjDir)/divide_core_test.c_pre.c.tb.o : divide_core_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) divide_core_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/divide_core.c_pre.c.tb.o : divide_core.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) divide_core.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
