...
# 269 "E:/Pedro/Programs/Xilinx/Vitis_HLS/2022.2/common/technology/autopilot\\etc/autopilot_ssdm_op.h"
...
# 2 "<built-in>" 2
# 1 "lab_01_hls/divide_core.c" 2
__attribute__((sdx_kernel("divide", 0))) void divide(unsigned char N, unsigned char D, unsigned char *Q, unsigned char *R) {
#line 14 "C:/Users/pcost/Documents/github/Dissertation/training/leonardo_tutorials_hls/lab_01_hls/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=divide
# 1 "lab_01_hls/divide_core.c"

 *Q = 0;
 *R = N;
 VITIS_LOOP_4_1: while ((*R) >= D) {
  *Q = *Q + 1;
  *R = *R - D;
 }
}
