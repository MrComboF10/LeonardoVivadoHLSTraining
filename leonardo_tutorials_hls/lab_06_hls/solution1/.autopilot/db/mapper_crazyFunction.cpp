...
using hls::sim::Byte;
extern "C" void crazyFunction(Byte<4>*, float, Byte<4>*);
extern "C" void apatb_crazyFunction_hw(volatile void * __xlx_apatb_param_x, float __xlx_apatb_param_y, volatile void * __xlx_apatb_param_res) {
...
__xlx_res__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_res)[i]);
  ...
  // DUT call
  crazyFunction(__xlx_x__tmp_vec.data(), __xlx_apatb_param_y, __xlx_res__tmp_vec.data());
