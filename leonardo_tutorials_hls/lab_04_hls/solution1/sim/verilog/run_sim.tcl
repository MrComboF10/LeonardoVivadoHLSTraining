...
if {[file isfile distPoints_float.autotvin.dat]} {
	file delete -force distPoints_float.autotvin.dat
}

if {[file isfile distPoints_float.autotvout.dat]} {
	file delete -force distPoints_float.autotvout.dat
}
