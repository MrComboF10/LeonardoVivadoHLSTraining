...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.distPoints_float.autotvin_Ax.dat"
         "c.distPoints_float.autotvin_Ay.dat"
         "c.distPoints_float.autotvin_Bx.dat"
         "c.distPoints_float.autotvin_By.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.distPoints_float.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
