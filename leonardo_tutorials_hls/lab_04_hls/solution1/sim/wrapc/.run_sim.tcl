...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Pedro/Programs/Xilinx/Vitis_HLS/2022.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);E:/Pedro/Programs/Xilinx/Vitis_HLS/2022.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Pedro/Programs/Xilinx/Vitis_HLS/2022.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Pedro/Programs/Xilinx/Vitis_HLS/2022.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "distPoints_float.autotvin.dat"
	set constFileTvOut       "distPoints_float.autotvout.dat"
	set constFileHdlTvIn     "distPoints_float.autohdltvin.dat"
	set constFileHdlTvOut    "distPoints_float.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
